...
export default function SignaturePage() {
  ...
  const locateMine = (mineRow) => {
    ...
    const left = Math.max(0, Math.min(cx - container.clientWidth / (2 * 1), WALL_W - container.clientWidth / 1));
    const top  = Math.max(0, Math.min(cy - container.clientHeight / (2 * 1), WALL_H - container.clientHeight / 1));
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1 text-xs">
                  Zoom
                  {/* You can wire zoom later when we add a landing router */}
